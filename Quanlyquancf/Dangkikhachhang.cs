    ...
    public partial class Dangkikhachhang : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectSTR))
            {
                ...
                // Sau đó chèn vào KHACHHANG (dùng đúng MATK làm MAKH)
                string insertKH = "INSERT INTO KHACHHANG (MAKH, TENKH, SDTKH) VALUES (@makh, @hoten, @sdt)";
                SqlCommand cmdKH = new SqlCommand(insertKH, conn);
                cmdKH.Parameters.AddWithValue("@makh", maTK);
